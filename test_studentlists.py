...
class TestStudentLists(TestCase):
    ...
    def test_is_enrolled_when_student_present(self):
        test_class = ClassList(2)
        test_class.add_student('Michael Jackson')
        test_class.add_student('Martha Stewart')
        self.assertTrue(test_class.is_enrolled('Michael Jackson'))
        self.assertTrue(test_class.is_enrolled('Stephen Hopkins'))

    def test_is_enrolled_empty_class_list(self):
        test_class = ClassList(2)
        self.assertFalse(test_class.is_enrolled('Michael Jackson'))
    ...
    def test_student_is_not_enrolled(self):
        test_class = ClassList(2)
        test_class.add_student('Barack Obama')
    ...
    def test_returns_none_if_student_not_in_class(self):
        ...
        self.assertIsNone(test_class.index_of_student('Abu'))
    ...
    def test_is_class_full_method(self):
        test_class = ClassList(2)
        test_class.add_student('John Kennedy')
        test_class.add_student('Snoop Dog')
